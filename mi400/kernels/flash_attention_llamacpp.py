...
@triton.jit
def flash_attention_llamacpp(Q, K, V, bias, SM_SCALE: tl.constexpr, Out, seqlen_q, seqlen_k, stride_qz, stride_qh,
                             stride_qm, stride_qk, stride_kz, stride_kh, stride_kn, stride_kk, stride_vz, stride_vh,
                             stride_vk, stride_vn, stride_oz, stride_oh, stride_om, stride_on, stride_bz, stride_bh,
                             stride_bm, stride_bn, HQ: tl.constexpr, HK: tl.constexpr,
                             ACTUAL_BLOCK_DMODEL: tl.constexpr, BLOCK_M: tl.constexpr, BLOCK_DMODEL: tl.constexpr,
                             BLOCK_N: tl.constexpr, isllamacpp: tl.constexpr):
    ...
    if continue_condition:
        ...
        bias_ptrs = bias + offs_m[:, None] * stride_bm + offs_n[None, :] * stride_bn
        ...
        acc, l_i, m_i = _attn_fwd_inner(acc, l_i, m_i, q, k_ptrs, v_ptrs, bias_ptrs, stride_kn, stride_vk, stride_bn,
                                        start_m, seqlen_k, seqlen_q, block_min, block_max, BLOCK_M, BLOCK_DMODEL,
