...
```bash
# Change "mi450_8" to "mi450_<version_number>" where folders with "mi450_<version_number>" are generated by the ffm build scripts.
# As of writing, the latest version is 8, so we use "mi450_8"
export FFM_PATH=/workspaces/mi450_8
export FFM_BIN_PATH=$FFM_PATH/_builds/mi450/Release/bin
export HSA_MODEL_LIB=$FFM_PATH/_builds/mi450/Release/lib/libhsakmtmodel.so
...
export HSA_MODEL_TOML=$(realpath <work>/ffm.config.toml)
export HSA_MODEL_ARGS="ffm_validate_gprs_strict"
