...
.LBB0_0:
	...
	s_or_b32 s17, s1, s10
	v_add_lshl_u32 v150, v2, v34, 1
	v_add_lshl_u32 v151, v10, s22, 1
	s_ashr_i32 s1, s0, 31
	s_mov_b32 s19, 0x27000
	s_mov_b32 s18, 0x7ffffffe
	v_cndmask_b32_e32 v11, v30, v149, vcc
	v_cndmask_b32_e32 v13, v30, v150, vcc
	v_cndmask_b32_e32 v19, v30, v151, vcc
	v_add_lshl_u32 v152, v12, v34, 1
	s_lshl_b32 s27, s12, 7
	s_lshl_b64 s[22:23], s[0:1], 1
	buffer_load_dwordx4 v[2:5], v11, s[16:19], 0 offen
	buffer_load_dwordx4 v[6:9], v13, s[16:19], 0 offen
	v_cndmask_b32_e32 v20, v30, v152, vcc
	buffer_load_dwordx4 v[10:13], v19, s[16:19], 0 offen
	buffer_load_dwordx4 v[14:17], v20, s[16:19], 0 offen
	s_add_u32 s16, s4, s22
	v_mad_u64_u32 v[26:27], s[0:1], s12, v1, v[34:35]
	s_addc_u32 s17, s5, s23
	s_and_b32 s0, s12, 0x3fff
	s_bitset1_b32 s0, 14
	v_mul_lo_u32 v22, s12, v18
	s_and_b32 s1, s17, 0xffff
	s_lshl_b32 s24, s0, 16
	v_lshlrev_b32_e32 v153, 1, v26
	v_mul_lo_u32 v31, s12, v28
	v_add_lshl_u32 v155, v26, s27, 1
	s_or_b32 s17, s1, s24
	v_cndmask_b32_e32 v18, v30, v153, vcc
	v_add_lshl_u32 v154, v22, v34, 1
	v_cndmask_b32_e32 v26, v30, v155, vcc
	v_add_lshl_u32 v156, v31, v34, 1
	...
	v_add_u32_e32 v157, 0, v37
	s_add_i32 s1, 0, 0x8000
	s_movk_i32 s0, 0xff
	v_add_u32_e32 v164, s1, v37
	s_waitcnt vmcnt(7)
	...
	v_lshl_add_u32 v159, v35, 1, 0
	v_or_b32_e32 v1, 0x3000, v1
	v_add_u32_e32 v158, 0, v3
	s_waitcnt vmcnt(6)
	ds_write_b64 v159, v[6:7]
	v_or_b32_e32 v6, v2, v34
	s_waitcnt vmcnt(5)
	ds_write_b64 v157, v[10:11] offset:16384
	ds_write2st64_b64 v158, v[4:5], v[12:13] offset1:32
	v_or_b32_e32 v4, v36, v1
	v_or_b32_e32 v1, v2, v1
	v_add_u32_e32 v165, s1, v3
	s_movk_i32 s1, 0x100
	v_lshl_add_u32 v160, v6, 1, 0
	v_lshl_add_u32 v161, v4, 1, 0
	v_lshl_add_u32 v163, v1, 1, 0
	v_cmp_gt_u32_e32 vcc, s1, v0
	v_cmp_lt_u32_e64 s[0:1], s0, v0
	s_waitcnt vmcnt(4)
	ds_write_b64 v161, v[14:15]
	s_waitcnt vmcnt(3)
	ds_write_b64 v157, v[18:19] offset:32768
	ds_write_b64 v158, v[20:21] offset:32768
	s_waitcnt vmcnt(0)
	ds_write_b64 v159, v[22:23] offset:32768
	ds_write2st64_b64 v160, v[8:9], v[24:25] offset1:64
	ds_write_b64 v164, v[26:27] offset:16384
	ds_write_b64 v165, v[28:29] offset:16384
	ds_write_b64 v161, v[30:31] offset:32768
	ds_write2st64_b64 v163, v[16:17], v[32:33] offset1:64
	s_waitcnt lgkmcnt(0)
	s_barrier
...
; %bb.3:                                ; %.lr.ph
	...
	v_or_b32_e32 v5, 12, v5
	v_and_b32_e32 v12, 60, v148
	s_add_u32 s0, s4, s22
	v_and_or_b32 v4, v146, 16, v2
	v_and_or_b32 v7, v147, 48, v2
	...
	v_add3_u32 v166, 0, v3, v7
	v_xor_b32_e32 v3, v9, v12
	s_addc_u32 s5, s1, 0
	s_lshl_b32 s0, s11, 8
	v_lshlrev_b32_e32 v3, 1, v3
	s_ashr_i32 s1, s0, 31
	v_add3_u32 v167, 0, v3, v7
	v_xor_b32_e32 v3, v11, v12
	s_lshl_b64 s[0:1], s[0:1], 1
	v_lshlrev_b32_e32 v3, 1, v3
	s_add_u32 s0, s0, s2
	v_add3_u32 v168, 0, v3, v7
	...
	v_add3_u32 v169, 0, v3, v7
	s_addc_u32 s12, s1, 0
	s_add_i32 s16, s16, -1
	s_mov_b32 s3, 0x27000
	s_mov_b32 s2, 0x7ffffffe
	v_add_u32_e32 v170, v4, v6
	v_add_u32_e32 v171, v4, v8
	v_add_u32_e32 v172, v4, v10
	v_add_u32_e32 v173, v4, v2
...
.LBB0_4:                                ; =>This Inner Loop Header: Depth=1
	...
	buffer_load_dwordx4 v[134:137], v150, s[0:3], 0 offen
	buffer_load_dwordx4 v[142:145], v151, s[0:3], 0 offen
	buffer_load_dwordx4 v[130:133], v152, s[0:3], 0 offen
	ds_read2st64_b64 v[174:177], v170 offset1:8
	ds_read2st64_b64 v[178:181], v170 offset0:16 offset1:24
	ds_read2st64_b64 v[182:185], v170 offset0:32 offset1:40
	ds_read2st64_b64 v[186:189], v170 offset0:48 offset1:56
	ds_read2st64_b64 v[190:193], v166 offset0:64 offset1:80
	ds_read2st64_b64 v[194:197], v166 offset0:96 offset1:112
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	v_mfma_f32_16x16x16_f16 v[126:129], v[190:191], v[174:175], v[126:129]
	s_setprio 1
	v_mfma_f32_16x16x16_f16 v[122:125], v[192:193], v[174:175], v[122:125]
	v_mfma_f32_16x16x16_f16 v[118:121], v[194:195], v[174:175], v[118:121]
	v_mfma_f32_16x16x16_f16 v[114:117], v[196:197], v[174:175], v[114:117]
	v_mfma_f32_16x16x16_f16 v[110:113], v[190:191], v[176:177], v[110:113]
	v_mfma_f32_16x16x16_f16 v[106:109], v[192:193], v[176:177], v[106:109]
	v_mfma_f32_16x16x16_f16 v[102:105], v[194:195], v[176:177], v[102:105]
	v_mfma_f32_16x16x16_f16 v[98:101], v[196:197], v[176:177], v[98:101]
	v_mfma_f32_16x16x16_f16 v[94:97], v[190:191], v[178:179], v[94:97]
	v_mfma_f32_16x16x16_f16 v[90:93], v[192:193], v[178:179], v[90:93]
	v_mfma_f32_16x16x16_f16 v[86:89], v[194:195], v[178:179], v[86:89]
	v_mfma_f32_16x16x16_f16 v[82:85], v[196:197], v[178:179], v[82:85]
	v_mfma_f32_16x16x16_f16 v[78:81], v[190:191], v[180:181], v[78:81]
	v_mfma_f32_16x16x16_f16 v[74:77], v[192:193], v[180:181], v[74:77]
	v_mfma_f32_16x16x16_f16 v[70:73], v[194:195], v[180:181], v[70:73]
	v_mfma_f32_16x16x16_f16 v[66:69], v[196:197], v[180:181], v[66:69]
	v_mfma_f32_16x16x16_f16 v[62:65], v[190:191], v[182:183], v[62:65]
	v_mfma_f32_16x16x16_f16 v[58:61], v[192:193], v[182:183], v[58:61]
	v_mfma_f32_16x16x16_f16 v[54:57], v[194:195], v[182:183], v[54:57]
	v_mfma_f32_16x16x16_f16 v[50:53], v[196:197], v[182:183], v[50:53]
	v_mfma_f32_16x16x16_f16 v[46:49], v[190:191], v[184:185], v[46:49]
	v_mfma_f32_16x16x16_f16 v[42:45], v[192:193], v[184:185], v[42:45]
	v_mfma_f32_16x16x16_f16 v[38:41], v[194:195], v[184:185], v[38:41]
	v_mfma_f32_16x16x16_f16 v[34:37], v[196:197], v[184:185], v[34:37]
	v_mfma_f32_16x16x16_f16 v[30:33], v[190:191], v[186:187], v[30:33]
	v_mfma_f32_16x16x16_f16 v[26:29], v[192:193], v[186:187], v[26:29]
	v_mfma_f32_16x16x16_f16 v[22:25], v[194:195], v[186:187], v[22:25]
	v_mfma_f32_16x16x16_f16 v[18:21], v[196:197], v[186:187], v[18:21]
	v_mfma_f32_16x16x16_f16 v[14:17], v[190:191], v[188:189], v[14:17]
	v_mfma_f32_16x16x16_f16 v[10:13], v[192:193], v[188:189], v[10:13]
	v_mfma_f32_16x16x16_f16 v[6:9], v[194:195], v[188:189], v[6:9]
	v_mfma_f32_16x16x16_f16 v[2:5], v[196:197], v[188:189], v[2:5]
	s_setprio 0
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	...
	s_or_b32 s1, s0, s24
	s_mov_b32 s0, s4
	buffer_load_dwordx4 v[174:177], v153, s[0:3], 0 offen
	buffer_load_dwordx4 v[178:181], v154, s[0:3], 0 offen
	buffer_load_dwordx4 v[182:185], v155, s[0:3], 0 offen
	buffer_load_dwordx4 v[186:189], v156, s[0:3], 0 offen
	ds_read2st64_b64 v[190:193], v171 offset1:8
	ds_read2st64_b64 v[194:197], v171 offset0:16 offset1:24
	ds_read2st64_b64 v[198:201], v171 offset0:32 offset1:40
	ds_read2st64_b64 v[202:205], v171 offset0:48 offset1:56
	ds_read2st64_b64 v[206:209], v167 offset0:64 offset1:80
	ds_read2st64_b64 v[210:213], v167 offset0:96 offset1:112
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	v_mfma_f32_16x16x16_f16 v[126:129], v[206:207], v[190:191], v[126:129]
	s_setprio 1
	v_mfma_f32_16x16x16_f16 v[122:125], v[208:209], v[190:191], v[122:125]
	v_mfma_f32_16x16x16_f16 v[118:121], v[210:211], v[190:191], v[118:121]
	v_mfma_f32_16x16x16_f16 v[114:117], v[212:213], v[190:191], v[114:117]
	v_mfma_f32_16x16x16_f16 v[110:113], v[206:207], v[192:193], v[110:113]
	v_mfma_f32_16x16x16_f16 v[106:109], v[208:209], v[192:193], v[106:109]
	v_mfma_f32_16x16x16_f16 v[102:105], v[210:211], v[192:193], v[102:105]
	v_mfma_f32_16x16x16_f16 v[98:101], v[212:213], v[192:193], v[98:101]
	v_mfma_f32_16x16x16_f16 v[94:97], v[206:207], v[194:195], v[94:97]
	v_mfma_f32_16x16x16_f16 v[90:93], v[208:209], v[194:195], v[90:93]
	v_mfma_f32_16x16x16_f16 v[86:89], v[210:211], v[194:195], v[86:89]
	v_mfma_f32_16x16x16_f16 v[82:85], v[212:213], v[194:195], v[82:85]
	v_mfma_f32_16x16x16_f16 v[78:81], v[206:207], v[196:197], v[78:81]
	v_mfma_f32_16x16x16_f16 v[74:77], v[208:209], v[196:197], v[74:77]
	v_mfma_f32_16x16x16_f16 v[70:73], v[210:211], v[196:197], v[70:73]
	v_mfma_f32_16x16x16_f16 v[66:69], v[212:213], v[196:197], v[66:69]
	v_mfma_f32_16x16x16_f16 v[62:65], v[206:207], v[198:199], v[62:65]
	v_mfma_f32_16x16x16_f16 v[58:61], v[208:209], v[198:199], v[58:61]
	v_mfma_f32_16x16x16_f16 v[54:57], v[210:211], v[198:199], v[54:57]
	v_mfma_f32_16x16x16_f16 v[50:53], v[212:213], v[198:199], v[50:53]
	v_mfma_f32_16x16x16_f16 v[46:49], v[206:207], v[200:201], v[46:49]
	v_mfma_f32_16x16x16_f16 v[42:45], v[208:209], v[200:201], v[42:45]
	v_mfma_f32_16x16x16_f16 v[38:41], v[210:211], v[200:201], v[38:41]
	v_mfma_f32_16x16x16_f16 v[34:37], v[212:213], v[200:201], v[34:37]
	v_mfma_f32_16x16x16_f16 v[30:33], v[206:207], v[202:203], v[30:33]
	v_mfma_f32_16x16x16_f16 v[26:29], v[208:209], v[202:203], v[26:29]
	v_mfma_f32_16x16x16_f16 v[22:25], v[210:211], v[202:203], v[22:25]
	v_mfma_f32_16x16x16_f16 v[18:21], v[212:213], v[202:203], v[18:21]
	v_mfma_f32_16x16x16_f16 v[14:17], v[206:207], v[204:205], v[14:17]
	v_mfma_f32_16x16x16_f16 v[10:13], v[208:209], v[204:205], v[10:13]
	v_mfma_f32_16x16x16_f16 v[6:9], v[210:211], v[204:205], v[6:9]
	v_mfma_f32_16x16x16_f16 v[2:5], v[212:213], v[204:205], v[2:5]
	s_setprio 0
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	ds_read2st64_b64 v[190:193], v172 offset1:8
	ds_read2st64_b64 v[194:197], v172 offset0:16 offset1:24
	ds_read2st64_b64 v[198:201], v172 offset0:32 offset1:40
	ds_read2st64_b64 v[202:205], v172 offset0:48 offset1:56
	ds_read2st64_b64 v[206:209], v168 offset0:64 offset1:80
	ds_read2st64_b64 v[210:213], v168 offset0:96 offset1:112
	ds_read2st64_b64 v[214:217], v173 offset1:8
	ds_read2st64_b64 v[218:221], v173 offset0:16 offset1:24
	ds_read2st64_b64 v[222:225], v173 offset0:32 offset1:40
	ds_read2st64_b64 v[226:229], v173 offset0:48 offset1:56
	ds_read2st64_b64 v[230:233], v169 offset0:64 offset1:80
	ds_read2st64_b64 v[234:237], v169 offset0:96 offset1:112
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	...
	s_waitcnt vmcnt(6)
	ds_write_b64 v159, v[134:135]
	s_waitcnt vmcnt(5)
	ds_write_b64 v157, v[142:143] offset:16384
	ds_write2st64_b64 v158, v[140:141], v[144:145] offset1:32
	s_waitcnt vmcnt(4)
	ds_write_b64 v161, v[130:131]
	s_waitcnt vmcnt(3)
	ds_write_b64 v157, v[174:175] offset:32768
	ds_write_b64 v158, v[176:177] offset:32768
	s_waitcnt vmcnt(2)
	ds_write_b64 v159, v[178:179] offset:32768
	ds_write2st64_b64 v160, v[136:137], v[180:181] offset1:64
	s_waitcnt vmcnt(1)
	ds_write_b64 v164, v[182:183] offset:16384
	ds_write_b64 v165, v[184:185] offset:16384
	s_waitcnt vmcnt(0)
	ds_write_b64 v161, v[186:187] offset:32768
	ds_write2st64_b64 v163, v[132:133], v[188:189] offset1:64
	s_waitcnt lgkmcnt(0)
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	v_mfma_f32_16x16x16_f16 v[126:129], v[230:231], v[214:215], v[126:129]
	s_setprio 1
	v_mfma_f32_16x16x16_f16 v[122:125], v[232:233], v[214:215], v[122:125]
	v_mfma_f32_16x16x16_f16 v[118:121], v[234:235], v[214:215], v[118:121]
	v_mfma_f32_16x16x16_f16 v[114:117], v[236:237], v[214:215], v[114:117]
	v_mfma_f32_16x16x16_f16 v[110:113], v[230:231], v[216:217], v[110:113]
	v_mfma_f32_16x16x16_f16 v[106:109], v[232:233], v[216:217], v[106:109]
	v_mfma_f32_16x16x16_f16 v[102:105], v[234:235], v[216:217], v[102:105]
	v_mfma_f32_16x16x16_f16 v[98:101], v[236:237], v[216:217], v[98:101]
	v_mfma_f32_16x16x16_f16 v[94:97], v[230:231], v[218:219], v[94:97]
	v_mfma_f32_16x16x16_f16 v[90:93], v[232:233], v[218:219], v[90:93]
	v_mfma_f32_16x16x16_f16 v[86:89], v[234:235], v[218:219], v[86:89]
	v_mfma_f32_16x16x16_f16 v[82:85], v[236:237], v[218:219], v[82:85]
	v_mfma_f32_16x16x16_f16 v[78:81], v[230:231], v[220:221], v[78:81]
	v_mfma_f32_16x16x16_f16 v[74:77], v[232:233], v[220:221], v[74:77]
	v_mfma_f32_16x16x16_f16 v[70:73], v[234:235], v[220:221], v[70:73]
	v_mfma_f32_16x16x16_f16 v[66:69], v[236:237], v[220:221], v[66:69]
	v_mfma_f32_16x16x16_f16 v[62:65], v[230:231], v[222:223], v[62:65]
	v_mfma_f32_16x16x16_f16 v[58:61], v[232:233], v[222:223], v[58:61]
	v_mfma_f32_16x16x16_f16 v[54:57], v[234:235], v[222:223], v[54:57]
	v_mfma_f32_16x16x16_f16 v[50:53], v[236:237], v[222:223], v[50:53]
	v_mfma_f32_16x16x16_f16 v[46:49], v[230:231], v[224:225], v[46:49]
	v_mfma_f32_16x16x16_f16 v[42:45], v[232:233], v[224:225], v[42:45]
	v_mfma_f32_16x16x16_f16 v[38:41], v[234:235], v[224:225], v[38:41]
	v_mfma_f32_16x16x16_f16 v[34:37], v[236:237], v[224:225], v[34:37]
	v_mfma_f32_16x16x16_f16 v[30:33], v[230:231], v[226:227], v[30:33]
	v_mfma_f32_16x16x16_f16 v[26:29], v[232:233], v[226:227], v[26:29]
	v_mfma_f32_16x16x16_f16 v[22:25], v[234:235], v[226:227], v[22:25]
	v_mfma_f32_16x16x16_f16 v[18:21], v[236:237], v[226:227], v[18:21]
	v_mfma_f32_16x16x16_f16 v[14:17], v[230:231], v[228:229], v[14:17]
	v_mfma_f32_16x16x16_f16 v[10:13], v[232:233], v[228:229], v[10:13]
	v_mfma_f32_16x16x16_f16 v[6:9], v[234:235], v[228:229], v[6:9]
	v_mfma_f32_16x16x16_f16 v[2:5], v[236:237], v[228:229], v[2:5]
	s_setprio 0
	s_barrier
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
...
.LBB0_11:
	v_and_b32_e32 v138, 12, v1
	v_or_b32_e32 v142, 48, v138
	v_and_b32_e32 v131, 60, v148
	v_and_or_b32 v130, v147, 48, v162
	...
	v_add3_u32 v154, 0, v132, v130
	v_xor_b32_e32 v132, v131, v144
	v_xor_b32_e32 v131, v131, v138
	v_and_or_b32 v139, v146, 16, v162
	v_lshlrev_b32_e32 v151, 2, v162
	v_lshlrev_b32_e32 v132, 1, v132
	...
	v_lshl_add_u32 v163, v138, 1, v152
	...
	s_waitcnt lgkmcnt(5)
	v_mfma_f32_16x16x16_f16 v[126:129], v[134:135], v[164:165], v[126:129]
	...
	v_mfma_f32_16x16x16_f16 v[122:125], v[136:137], v[164:165], v[122:125]
	ds_read2st64_b64 v[176:179], v182 offset1:8
	s_waitcnt lgkmcnt(7)
	v_mfma_f32_16x16x16_f16 v[118:121], v[142:143], v[164:165], v[118:121]
	...
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_16x16x16_f16 v[126:129], v[130:131], v[168:169], v[126:129]
	v_mfma_f32_16x16x16_f16 v[122:125], v[132:133], v[168:169], v[122:125]
	v_mfma_f32_16x16x16_f16 v[118:121], v[150:151], v[168:169], v[118:121]
	...
	v_mfma_f32_16x16x16_f16 v[126:129], v[138:139], v[172:173], v[126:129]
	v_mfma_f32_16x16x16_f16 v[122:125], v[140:141], v[172:173], v[122:125]
	v_mfma_f32_16x16x16_f16 v[118:121], v[154:155], v[172:173], v[118:121]
...
.LBB0_12:
	...
	s_add_u32 s28, s2, s0
	v_or_b32_e32 v1, s14, v131
	v_or_b32_e32 v133, s14, v132
	v_or_b32_e32 v135, s14, v134
	v_or_b32_e32 v136, s14, v130
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set matmul_kernel.num_vgpr, 238
