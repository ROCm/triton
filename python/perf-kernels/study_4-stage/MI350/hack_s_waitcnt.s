...
.Ltmp1:
	...
	s_lshl_b64 s[0:1], s[0:1], 1
	s_add_u32 s2, s2, s0
	.loc	1 572 36 is_stmt 1              ; flash-attention.py:572:36
...
.Ltmp9:
	.loc	1 576 66                        ; flash-attention.py:576:66
...
.Ltmp10:
	...
	.loc	1 305 29                        ; flash-attention.py:305:29 @[ flash-attention.py:677:52 ]
...
.LBB0_2:
	...
	.loc	1 572 73 is_stmt 1              ; flash-attention.py:572:73
...
.Ltmp12:
	.loc	1 248 47 is_stmt 1              ; flash-attention.py:248:47 @[ flash-attention.py:677:52 ]
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	.loc	1 285 28 is_stmt 1              ; flash-attention.py:285:28 @[ flash-attention.py:677:52 ]
	s_waitcnt lgkmcnt(0)
...
.Ltmp19:
	...
	s_addc_u32 s6, s9, s3
.Ltmp20:
	.loc	1 340 51 is_stmt 1              ; flash-attention.py:340:51 @[ flash-attention.py:677:52 ]
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x16_f16 v[98:113], v[2:5], v[126:129], v[98:113]
.Ltmp21:
	.loc	1 731 68                        ; flash-attention.py:731:68
	s_lshl_b32 s2, s17, 14
	.loc	1 731 58 is_stmt 0              ; flash-attention.py:731:58
	s_ashr_i32 s3, s2, 31
	s_lshl_b64 s[2:3], s[2:3], 2
	s_add_u32 s4, s4, s2
	s_addc_u32 s6, s6, s3
...
.LBB0_10:                               ; %.critedge
	...
	.loc	1 743 33                        ; flash-attention.py:743:33
	s_add_u32 s2, s10, s0
	.loc	1 743 63 is_stmt 0              ; flash-attention.py:743:63
	s_mul_i32 s0, s26, s17
	.loc	1 711 28 is_stmt 1              ; flash-attention.py:711:28
	v_pk_mul_f32 v[12:13], v[0:1], v[12:13] op_sel_hi:[0,1]
	v_pk_mul_f32 v[10:11], v[0:1], v[10:11] op_sel_hi:[0,1]
	.loc	1 722 29                        ; flash-attention.py:722:29
