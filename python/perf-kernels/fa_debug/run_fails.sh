...
# After fixing
HIP_VISIBLE_DEVICES=3 TRITON_MLIR_DUMP_REFINE_OPS=1 TRITON_ALWAYS_COMPILE=1 MLIR_ENABLE_DUMP=1 TRITON_HIP_STREAM_MAX_DEPTH=1 \
  FA_CONFIG=./config_fail.yaml \
  python3 ./flash-attention.py \
  -b 4 -hq 48 -hk 24 -sq 1024 -sk 1024 -d 64 -causal -layout thd &> fail.mlir &
