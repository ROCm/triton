...
usage: Draw triton layouts [-h] [--output OUTPUT] [--keep] PLOT_TYPE ...
...
Examples:
```bash
python3 plot_layout.py blocked --tensorShape 128 64 --sizePerThread 1 8 --threadsPerWarp 8 8 --warpsPerCTA 4 1
python3 plot_layout.py blocked --tensorShape 16 64 --sizePerThread 1 8 --threadsPerWarp 16 4 --warpsPerCTA 1 2
python3 plot_layout.py blocked --tensorShape 32 64 --sizePerThread 8 1 --threadsPerWarp 4 16 --warpsPerCTA 1 2 --order 0 1
```
