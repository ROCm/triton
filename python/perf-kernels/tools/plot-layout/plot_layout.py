...
def parse_args():
    ...
    top_parser.add_argument("--force", action='store_true', default=False, help='If set, overwrite the pdf file with the same name')
    ...
    blocked_parser.add_argument("-B", "--matrixB", action="store_true", help='shortcut to plot operand B with dimension name of (K, N)')
    ...
    blocked_parser.add_argument("-b", "--blockShape", type=int, nargs=2, metavar=("b0", "b1"),
