...
def get_llvm_package_info():
    ...
    url = f"https://github.com/ROCm/triton/releases/download/llvm-6e3b4759-almalinux/llvm-6e3b4759-almalinux-x64.tar.gz"
...
setup(
    ...
    version="3.3.1" + os.environ.get("TRITON_WHEEL_VERSION_SUFFIX", ""),
