...
.LBB0_0:
	...
	v_xor_b32_e32 v155, 0x80, v9
	v_lshlrev_b32_e32 v9, 10, v38
	v_lshrrev_b32_e32 v10, 2, v39
	v_or_b32_e32 v10, v9, v10
	s_and_b32 s1, s21, 0x3fff
	v_add_u32_e32 v158, 0, v10
	v_lshrrev_b32_e32 v10, 2, v1
	v_lshlrev_b32_e32 v11, 1, v0
	s_lshl_b32 s0, s21, 6
	s_or_b32 s12, s1, 0x4000
	v_xor_b32_e32 v154, v2, v4
	s_and_b32 s1, s24, 0x3fff
	v_lshrrev_b32_e32 v9, 6, v9
	v_lshl_or_b32 v10, v148, 7, v10
	v_and_b32_e32 v12, 56, v11
	v_or_b32_e32 v13, 64, v11
	v_or_b32_e32 v14, 0x80, v11
	v_or_b32_e32 v11, 0xc0, v11
	v_add_lshl_u32 v153, v36, s5, 1
	v_xor_b32_e32 v2, 32, v154
	v_xor_b32_e32 v3, 64, v154
	v_xor_b32_e32 v4, 0x60, v154
	v_xor_b32_e32 v5, 0x80, v154
	v_xor_b32_e32 v6, 0xa0, v154
	v_xor_b32_e32 v7, 0xc0, v154
	v_xor_b32_e32 v8, 0xe0, v154
	...
	s_ashr_i32 s5, s4, 31
	v_mov_b32_e32 v18, 0
	v_lshlrev_b32_e32 v152, 1, v36
	v_lshlrev_b32_e32 v156, 1, v34
	v_add_lshl_u32 v157, v34, s24, 1
	s_lshl_b64 s[4:5], s[4:5], 1
	s_lshl_b64 s[6:7], s[0:1], 1
	s_lshl_b32 s20, s12, 16
	v_add_u32_e32 v159, 0, v2
	v_add_u32_e32 v160, 0, v3
	v_add_u32_e32 v161, 0, v4
	v_add_u32_e32 v162, 0, v5
	v_add_u32_e32 v163, 0, v6
	v_add_u32_e32 v164, 0, v7
	v_add_u32_e32 v165, 0, v8
	s_mov_b32 s37, s36
	s_mov_b32 s38, s36
	s_mov_b32 s39, s36
	s_mov_b32 s40, s36
	...
	v_add_u32_e32 v166, v158, v9
	v_add_u32_e32 v167, v10, v12
	v_add_u32_e32 v168, v10, v13
	v_add_u32_e32 v169, v10, v14
	v_add_u32_e32 v170, v10, v11
	...
	v_mov_b32_e32 v171, 1.0
	v_mov_b32_e32 v147, 0xff800000
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	s_and_b32 s1, s15, 0xffff
	s_mov_b32 s0, s13
	s_or_b32 s1, s1, s20
	buffer_load_dwordx4 v[66:69], v152, s[0:3], 0 offen
	buffer_load_dwordx4 v[70:73], v153, s[0:3], 0 offen
	v_add_u32_e32 v74, 0, v154
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_read_b128 v[176:179], v74 offset:8192
	s_waitcnt lgkmcnt(1)
	v_mfma_f32_32x32x8_f16 v[82:97], v[172:173], v[114:115], v[98:113]
	v_add_u32_e32 v172, v158, v151
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_f16 v[66:81], v[176:177], v[114:115], v[98:113]
	s_nop 6
	ds_read_b128 v[98:101], v159
	ds_read_b128 v[102:105], v159 offset:8192
	v_add_u32_e32 v176, 0x1000, v168
	v_add_u32_e32 v177, 0x2000, v169
	v_mfma_f32_32x32x8_f16 v[82:97], v[174:175], v[116:117], v[82:97]
	v_mfma_f32_32x32x8_f16 v[66:81], v[178:179], v[116:117], v[66:81]
	v_add_u32_e32 v178, 0x3000, v170
	s_waitcnt lgkmcnt(1)
	...
	ds_read_b128 v[98:101], v163
	ds_read_b128 v[102:105], v163 offset:8192
	s_waitcnt lgkmcnt(1)
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_32x32x8_f16 v[18:33], v[172:173], v[84:85], v[18:33]
	v_exp_f32_e32 v172, v89
	ds_read2_b64 v[84:87], v167 offset0:4 offset1:6
	v_exp_f32_e32 v173, v92
	v_cvt_pkrtz_f16_f32 v89, v109, v172
	s_nop 1
	...
	v_mfma_f32_32x32x8_f16 v[18:33], v[174:175], v[88:89], v[18:33]
	ds_read2_b64 v[88:91], v176 offset0:4 offset1:6
	v_exp_f32_e32 v174, v93
	s_nop 0
	v_cvt_pkrtz_f16_f32 v93, v173, v174
	s_waitcnt lgkmcnt(3)
	s_nop 0
	...
	v_cvt_pkrtz_f16_f32 v70, v175, v92
	...
	ds_bpermute_b32 v66, v155, v68
	s_waitcnt lgkmcnt(0)
	v_add_f32_e32 v171, v68, v66
	v_fmac_f32_e32 v171, v97, v82
...
.LBB0_6:                                ; %.critedge
	v_div_scale_f32 v0, s[0:1], v171, v171, 1.0
	v_rcp_f32_e32 v67, v0
	v_div_scale_f32 v68, vcc, 1.0, v171, 1.0
	...
	v_div_fixup_f32 v0, v0, v171, 1.0
