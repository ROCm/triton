...
__OCP_FP_HOST_DEVICE_STATIC__ float __amd_cvt_fp8_to_float_scale(
  ...
  __amd_floatx8_storage_t ret = interpret == __AMD_OCP_E4M3
      ? __builtin_amdgcn_cvt_scale_pk8_f32_fp8(u.ui32x2, scale, 0)
      : __builtin_amdgcn_cvt_scale_pk8_f32_bf8(u.ui32x2, scale, 0);
  return ret[0];
...
#if __has_builtin(__builtin_amdgcn_cvt_pk_f32_fp8) and                                             \
...
#if __has_builtin(__builtin_amdgcn_cvt_pk_fp8_f32) and                                             \
    __has_builtin(__builtin_amdgcn_cvt_pk_bf8_f32)
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_floatx2_storage_t __amd_cvt_fp4x2_to_floatx2_scale(
  ...
  u.fp4x2[0] = val;
  __amd_floatx8_storage_t ret = __builtin_amdgcn_cvt_scale_pk8_f32_fp4(u.ui32, scale, 0);
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_fp16x2_storage_t __amd_cvt_fp8x2_to_fp16x2_scale(
  ...
  if (interpret == __AMD_OCP_E4M3) {
    ret = __builtin_amdgcn_cvt_scale_pk8_f16_fp8(u.ui32x2, scale, 0);
  } else {
    ret = __builtin_amdgcn_cvt_scale_pk8_f16_bf8(u.ui32x2, scale, 0);
  }
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_fp16x8_storage_t __amd_cvt_fp8x8_to_fp16x8_scale(
  ...
  if (interpret == __AMD_OCP_E4M3) {
    return __builtin_amdgcn_cvt_scale_pk8_f16_fp8(u.ui32x2, scale, 0);
  } else {
    return __builtin_amdgcn_cvt_scale_pk8_f16_bf8(u.ui32x2, scale, 0);
  }
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_bf16x2_storage_t __amd_cvt_fp8x2_to_bf16x2_scale(
  ...
  if (interpret == __AMD_OCP_E4M3) {
    ret = __builtin_amdgcn_cvt_scale_pk8_bf16_fp8(u.ui32x2, scale, 0);
  } else {
    ret = __builtin_amdgcn_cvt_scale_pk8_bf16_bf8(u.ui32x2, scale, 0);
  }
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_bf16x8_storage_t __amd_cvt_fp8x8_to_bf16x8_scale(
  ...
  if (interpret == __AMD_OCP_E4M3) {
    return __builtin_amdgcn_cvt_scale_pk8_bf16_fp8(u.ui32x2, scale, 0 /* what is this? */);
  } else {
    return __builtin_amdgcn_cvt_scale_pk8_bf16_bf8(u.ui32x2, scale, 0 /* what is this? */);
  }
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_fp16x32_storage_t __amd_cvt_fp6x32_to_fp16x32_scale(
    ...
    const __amd_scale_t scale) {
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3 ? __builtin_amdgcn_cvt_scale_pk32_f16_fp6(in, scale, 0)
                                     : __builtin_amdgcn_cvt_scale_pk32_f16_bf6(in, scale, 0);
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_bf16x32_storage_t __amd_cvt_fp6x32_to_bf16x32_scale(
    ...
    const __amd_scale_t scale) {
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3 ? __builtin_amdgcn_cvt_scale_pk32_bf16_fp6(in, scale, 0)
                                     : __builtin_amdgcn_cvt_scale_pk32_bf16_bf6(in, scale, 0);
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_floatx32_storage_t __amd_cvt_fp6x32_to_floatx32_scale(
    ...
    const __amd_scale_t scale) {
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3 ? __builtin_amdgcn_cvt_scale_pk32_f32_fp6(val, scale, 0)
                                     : __builtin_amdgcn_cvt_scale_pk32_f32_bf6(val, scale, 0);
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_fp16x2_storage_t __amd_cvt_fp4x2_to_fp16x2_scale(
  ...
  u.fp4x2[0] = in;
  ret.fp16x8 = __builtin_amdgcn_cvt_scale_pk8_f16_fp4(u.ui32, scale, 0);
  return ret.fp16x2[0];
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
...
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  return __builtin_amdgcn_cvt_scale_pk8_f16_fp4((unsigned int)in, scale, 0);
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  static_assert(sizeof(__amd_fp4x2_storage_t[4]) == sizeof(unsigned int));
  static_assert(sizeof(__amd_fp16x2_storage_t[4]) == sizeof(__amd_fp16x8_storage_t));
  union {
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_bf16x2_storage_t __amd_cvt_fp4x2_to_bf16x2_scale(
  ...
  u.fp4x2[0] = in;
  ret.bf16x8 = __builtin_amdgcn_cvt_scale_pk8_bf16_fp4(u.ui32, scale, 0);
  return ret.bf16x2[0];
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_bf16x8_storage_t __amd_cvt_fp4x8_to_bf16x8_scale(
    const __amd_fp4x8_storage_t in, const __amd_fp4_interpretation_t, const __amd_scale_t scale) {
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  return __builtin_amdgcn_cvt_scale_pk8_bf16_fp4((unsigned int)in, scale, 0);
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  static_assert(sizeof(__amd_fp4x2_storage_t[4]) == sizeof(unsigned int));
  static_assert(sizeof(__amd_bf16x2_storage_t[4]) == sizeof(__amd_bf16x8_storage_t));
  union {
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_floatx8_storage_t __amd_cvt_fp4x8_to_floatx8_scale(
  ...
  return __builtin_amdgcn_cvt_scale_pk8_f32_fp4(u.ui32, scale, 0);
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  static_assert(sizeof(__amd_fp4x2_storage_t[4]) == sizeof(__amd_fp4x8_storage_t));
  union {
    __amd_fp4x8_storage_t fp4x8;
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_floatx8_storage_t __amd_cvt_fp8x8_to_floatx8_scale(
  ...
  if (interpret == __AMD_OCP_E4M3) {
    return __builtin_amdgcn_cvt_scale_pk8_f32_fp8(u.ui32x2, scale, 0);
  } else {
    return __builtin_amdgcn_cvt_scale_pk8_f32_bf8(u.ui32x2, scale, 0);
  }
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  static_assert(sizeof(__amd_fp8x8_storage_t) == sizeof(__amd_fp8x2_storage_t[4]));
  union {
...
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  __amd_floatx32_storage_t val{in1[0],  in1[1],  in1[2],  in1[3],  in1[4],  in1[5],  in1[6],
                               in1[7],  in1[8],  in1[9],  in1[10], in1[11], in1[12], in1[13],
                               in1[14], in1[15], in2[0],  in2[1],  in2[2],  in2[3],  in2[4],
                               in2[5],  in2[6],  in2[7],  in2[8],  in2[9],  in2[10], in2[11],
                               in2[12], in2[13], in2[14], in2[15]};
  return interpret == __AMD_OCP_E2M3
      ? __builtin_amdgcn_cvt_scalef32_pk32_fp6_f32(val, __amd_scale_to_float(scale))
      : __builtin_amdgcn_cvt_scalef32_pk32_bf6_f32(val, __amd_scale_to_float(scale));
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3
...
__OCP_FP_HOST_DEVICE_STATIC__ __amd_fp6x32_storage_t __amd_cvt_fp16x32_to_fp6x32_sr_scale(
    const __amd_fp16x32_storage_t in, const __amd_fp6_interpretation_t interpret,
    const unsigned int round, const __amd_scale_t scale) {
#if HIP_ENABLE_GFX1250_OCP_BUILTINS or HIP_ENABLE_GFX950_OCP_BUILTINS
  return interpret == __AMD_OCP_E2M3
...
#if HIP_ENABLE_GFX1250_OCP_BUILTINS
  if (interpret == __AMD_OCP_E4M3) {
    return __builtin_amdgcn_cvt_pk_fp8_f16(val[0], val[1]);
  } else {
    return __builtin_amdgcn_cvt_pk_bf8_f16(val[0], val[1]);
  }
#elif HIP_ENABLE_GFX950_OCP_BUILTINS
  static_assert(sizeof(__amd_shortx2_storage_t) == sizeof(__amd_fp8x2_storage_t[2]));
  union {
