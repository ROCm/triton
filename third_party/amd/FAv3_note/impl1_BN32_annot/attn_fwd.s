...
.LBB0_0:
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_dwordx4 v[2:5], v84, s[28:31], 0 offen
	s_movk_i32 s0, 0xe0
	...
	s_waitcnt lgkmcnt(0)
	s_barrier
	buffer_load_dwordx4 v[18:21], v84, s[0:3], 0 offen
	v_add3_u32 v183, 0, v10, v40
	v_add3_u32 v182, 0, v25, v40
	v_add3_u32 v181, 0, v34, v40
	v_add3_u32 v184, 0, v35, v40
	...
	s_mov_b32 s15, s3
	v_add_lshl_u32 v185, v23, v22, 1
	s_or_b32 s13, s13, s19
	v_add3_u32 v186, 0, v36, v40
	...
	buffer_load_dwordx4 v[34:37], v185, s[12:15], 0 offen
	s_mul_i32 s15, s21, 0xc0
	s_add_u32 s21, s12, s6
	s_addc_u32 s29, s33, s7
	s_and_b32 s1, s1, 0xffff
	v_add3_u32 v187, 0, v38, v40
	v_add3_u32 v188, 0, v39, v40
	...
	v_exp_f32_e32 v201, v5
	v_exp_f32_e32 v200, v6
	v_exp_f32_e32 v199, v7
	v_exp_f32_e32 v198, v8
	v_exp_f32_e32 v197, v9
	v_exp_f32_e32 v196, v10
	v_exp_f32_e32 v195, v11
	v_exp_f32_e32 v194, v12
	v_exp_f32_e32 v193, v13
	v_exp_f32_e32 v192, v14
	v_exp_f32_e32 v191, v15
	v_exp_f32_e32 v190, v16
	v_exp_f32_e32 v189, v17
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_f32_e32 v83, v203, v204
	v_add_f32_e32 v83, v83, v202
	v_add_f32_e32 v83, v83, v201
	v_add_f32_e32 v83, v83, v200
	v_add_f32_e32 v83, v83, v199
	v_add_f32_e32 v83, v83, v198
	v_add_f32_e32 v83, v83, v197
	v_mfma_f32_32x32x8_f16 v[66:81], v[168:169], v[128:129], v[66:81]
	v_add_f32_e32 v83, v83, v196
	v_add_f32_e32 v83, v83, v195
	v_add_f32_e32 v83, v83, v194
	v_add_f32_e32 v83, v83, v193
	v_add_f32_e32 v83, v83, v192
	v_add_f32_e32 v83, v83, v191
	v_add_f32_e32 v83, v83, v190
	s_waitcnt lgkmcnt(6)
	v_mfma_f32_32x32x8_f16 v[66:81], v[162:163], v[122:123], v[66:81]
	v_add_f32_e32 v83, v83, v189
	ds_bpermute_b32 v86, v175, v83
	...
	buffer_load_dwordx4 v[130:133], v84, s[0:3], 0 offen
	ds_read_u16 v82, v85
	ds_read_u16 v141, v85 offset:64
	ds_read_u16 v144, v85 offset:128
	ds_read_u16 v83, v85 offset:512
	ds_read_u16 v145, v85 offset:576
	ds_read_u16 v147, v85 offset:640
	ds_read_u16 v148, v85 offset:2048
	ds_read_u16 v149, v85 offset:2112
	ds_read_u16 v150, v85 offset:2176
	ds_read_u16 v151, v85 offset:2560
	ds_read_u16 v152, v85 offset:2624
	ds_read_u16 v153, v85 offset:2688
	ds_read_u16 v154, v85 offset:4096
	ds_read_u16 v155, v85 offset:4160
	ds_read_u16 v156, v85 offset:4224
	ds_read_u16 v157, v85 offset:4608
	ds_read_u16 v158, v85 offset:4672
	ds_read_u16 v159, v85 offset:4736
	ds_read_u16 v160, v85 offset:6144
	ds_read_u16 v161, v85 offset:6208
	ds_read_u16 v162, v85 offset:6272
	ds_read_u16 v163, v85 offset:6656
	ds_read_u16 v164, v85 offset:6720
	ds_read_u16 v165, v85 offset:6784
	ds_read_u16 v166, v85 offset:320
	ds_read_u16 v167, v85 offset:384
	ds_read_u16 v168, v85 offset:448
	ds_read_u16 v86, v85 offset:256
	ds_read_u16 v169, v85 offset:192
	ds_read_u16 v170, v85 offset:832
	ds_read_u16 v171, v85 offset:896
	ds_read_u16 v173, v85 offset:960
	ds_read_u16 v87, v85 offset:768
	ds_read_u16 v189, v85 offset:704
	ds_read_u16 v190, v85 offset:2368
	ds_read_u16 v191, v85 offset:2432
	ds_read_u16 v192, v85 offset:2496
	ds_read_u16 v193, v85 offset:2304
	ds_read_u16 v194, v85 offset:2240
	ds_read_u16 v195, v85 offset:2880
	ds_read_u16 v196, v85 offset:2944
	ds_read_u16 v197, v85 offset:3008
	ds_read_u16 v198, v85 offset:2816
	ds_read_u16 v199, v85 offset:2752
	ds_read_u16 v200, v85 offset:4416
	ds_read_u16 v201, v85 offset:4480
	ds_read_u16 v202, v85 offset:4544
	ds_read_u16 v203, v85 offset:4352
	ds_read_u16 v204, v85 offset:4288
	ds_read_u16 v206, v85 offset:4928
	ds_read_u16 v207, v85 offset:4992
	ds_read_u16 v208, v85 offset:5056
	ds_read_u16 v209, v85 offset:4864
	ds_read_u16 v210, v85 offset:4800
	ds_read_u16 v211, v85 offset:6464
	ds_read_u16 v212, v85 offset:6528
	ds_read_u16 v213, v85 offset:6592
	ds_read_u16 v214, v85 offset:6400
	ds_read_u16 v215, v85 offset:6336
	ds_read_u16 v216, v85 offset:6976
	ds_read_u16 v217, v85 offset:7040
	ds_read_u16 v218, v85 offset:7104
	ds_read_u16 v219, v85 offset:6912
	ds_read_u16 v220, v85 offset:6848
	; sched_barrier mask(0x00000000)
	s_waitcnt lgkmcnt(14)
	v_perm_b32 v87, v87, v83, s28
	v_perm_b32 v86, v86, v82, s28
	v_pack_b32_f16 v83, v90, v91
	v_pack_b32_f16 v82, v88, v89
	v_pack_b32_f16 v89, v94, v95
	v_pack_b32_f16 v88, v92, v93
	v_mfma_f32_32x32x8_f16 v[50:65], v[86:87], v[82:83], v[50:65]
	v_perm_b32 v87, v198, v151, s28
	v_perm_b32 v86, v193, v148, s28
	v_pack_b32_f16 v91, v142, v143
	v_pack_b32_f16 v90, v96, v97
	v_pack_b32_f16 v93, v139, v140
	v_pack_b32_f16 v92, v146, v138
	v_perm_b32 v140, v168, v169, s28
	v_mfma_f32_32x32x8_f16 v[50:65], v[86:87], v[88:89], v[50:65]
	s_waitcnt lgkmcnt(11)
	v_perm_b32 v87, v209, v157, s28
	v_perm_b32 v86, v203, v154, s28
	v_perm_b32 v97, v196, v153, s28
	v_perm_b32 v96, v191, v150, s28
	v_perm_b32 v143, v197, v199, s28
	v_perm_b32 v142, v192, v194, s28
	v_perm_b32 v139, v207, v159, s28
	v_mfma_f32_32x32x8_f16 v[50:65], v[86:87], v[90:91], v[50:65]
	s_waitcnt lgkmcnt(1)
	v_perm_b32 v87, v219, v163, s28
	v_perm_b32 v86, v214, v160, s28
	v_perm_b32 v138, v201, v156, s28
	v_perm_b32 v95, v216, v164, s28
	v_perm_b32 v94, v211, v161, s28
	v_mfma_f32_32x32x8_f16 v[50:65], v[86:87], v[92:93], v[50:65]
	v_perm_b32 v87, v170, v145, s28
	v_perm_b32 v86, v166, v141, s28
	v_perm_b32 v141, v173, v189, s28
	v_perm_b32 v145, v208, v210, s28
	v_mfma_f32_32x32x8_f16 v[34:49], v[86:87], v[82:83], v[34:49]
	v_perm_b32 v87, v195, v152, s28
	v_perm_b32 v86, v190, v149, s28
	s_nop 1
	v_mfma_f32_32x32x8_f16 v[34:49], v[86:87], v[88:89], v[34:49]
	v_perm_b32 v87, v206, v158, s28
	v_perm_b32 v86, v200, v155, s28
	s_nop 1
	v_mfma_f32_32x32x8_f16 v[34:49], v[86:87], v[90:91], v[34:49]
	v_perm_b32 v87, v171, v147, s28
	v_perm_b32 v86, v167, v144, s28
	v_perm_b32 v144, v202, v204, s28
	s_nop 0
	v_mfma_f32_32x32x8_f16 v[18:33], v[86:87], v[82:83], v[18:33]
	...
	v_mfma_f32_32x32x8_f16 v[2:17], v[140:141], v[82:83], v[2:17]
	v_max3_f32 v86, v86, v76, v77
	v_max3_f32 v86, v86, v78, v79
	s_waitcnt lgkmcnt(0)
	v_perm_b32 v87, v218, v220, s28
	v_mfma_f32_32x32x8_f16 v[18:33], v[96:97], v[88:89], v[18:33]
	v_max3_f32 v96, v86, v80, v81
	ds_bpermute_b32 v97, v175, v96
	v_perm_b32 v86, v213, v215, s28
	s_waitcnt lgkmcnt(0)
	v_max3_f32 v173, v172, v96, v97
	v_mfma_f32_32x32x8_f16 v[2:17], v[142:143], v[88:89], v[2:17]
	...
	v_mfma_f32_32x32x8_f16 v[2:17], v[144:145], v[90:91], v[2:17]
	...
	v_sub_f32_e32 v66, v170, v171
	v_exp_f32_e32 v204, v67
	v_mfma_f32_32x32x8_f16 v[34:49], v[94:95], v[92:93], v[34:49]
	v_perm_b32 v95, v217, v165, s28
	v_perm_b32 v94, v212, v162, s28
	v_exp_f32_e32 v202, v68
	v_exp_f32_e32 v201, v69
	v_exp_f32_e32 v200, v70
	v_exp_f32_e32 v199, v71
	v_exp_f32_e32 v198, v72
	v_mfma_f32_32x32x8_f16 v[18:33], v[94:95], v[92:93], v[18:33]
	v_exp_f32_e32 v197, v73
	v_exp_f32_e32 v196, v74
	v_exp_f32_e32 v195, v75
	v_exp_f32_e32 v194, v76
	v_exp_f32_e32 v193, v77
	v_exp_f32_e32 v192, v78
	v_exp_f32_e32 v191, v79
	v_mfma_f32_32x32x8_f16 v[2:17], v[86:87], v[92:93], v[2:17]
	v_exp_f32_e32 v190, v80
	v_exp_f32_e32 v189, v81
	...
	s_barrier
	s_waitcnt vmcnt(1)
	ds_write_b128 v177, v[134:137] offset:8192
	buffer_load_dwordx4 v[134:137], v185, s[12:15], 0 offen
	ds_read_b128 v[166:169], v180
	ds_read_b128 v[162:165], v183
	ds_read_b128 v[158:161], v182
	ds_read_b128 v[154:157], v181
...
; %bb.2:
	...
	v_pk_mul_f32 v[52:53], v[52:53], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[50:51], v[50:51], v[170:171] op_sel_hi:[1,0]
	v_cvt_f16_f32_e32 v166, v198
	v_cvt_f16_f32_e32 v167, v197
	v_cvt_f16_f32_e32 v168, v196
	v_cvt_f16_f32_e32 v169, v195
	v_mfma_f32_32x32x8_f16 v[82:97], v[162:163], v[122:123], v[82:97]
	v_cvt_f16_f32_e32 v162, v203
	v_cvt_f16_f32_e32 v163, v204
	v_cvt_f16_f32_e32 v172, v192
	v_cvt_f16_f32_e32 v206, v191
	v_cvt_f16_f32_e32 v207, v190
	v_cvt_f16_f32_e32 v208, v189
	v_pk_mul_f32 v[48:49], v[48:49], v[170:171] op_sel_hi:[1,0]
	v_mfma_f32_32x32x8_f16 v[82:97], v[164:165], v[124:125], v[82:97]
	v_cvt_f16_f32_e32 v164, v202
	v_cvt_f16_f32_e32 v165, v199
	v_pk_mul_f32 v[46:47], v[46:47], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[44:45], v[44:45], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[42:43], v[42:43], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[40:41], v[40:41], v[170:171] op_sel_hi:[1,0]
	...
	v_cvt_f16_f32_e32 v158, v201
	v_cvt_f16_f32_e32 v159, v200
	v_pk_mul_f32 v[36:37], v[36:37], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[34:35], v[34:35], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[32:33], v[32:33], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[30:31], v[30:31], v[170:171] op_sel_hi:[1,0]
	...
	v_cvt_f16_f32_e32 v160, v194
	v_cvt_f16_f32_e32 v161, v193
	v_pk_mul_f32 v[26:27], v[26:27], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[24:25], v[24:25], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[22:23], v[22:23], v[170:171] op_sel_hi:[1,0]
	v_pk_mul_f32 v[20:21], v[20:21], v[170:171] op_sel_hi:[1,0]
	...
	s_waitcnt lgkmcnt(1)
	v_max3_f32 v133, v173, v148, v146
	v_pk_mul_f32 v[130:131], v[132:133], s[6:7] op_sel_hi:[1,0]
	s_nop 0
	v_fma_f32 v97, v82, s6, -v131
	v_fma_f32 v132, v83, s6, -v131
	v_fma_f32 v93, v93, s6, -v131
	v_mfma_f32_32x32x8_f16 v[2:17], v[144:145], v[138:139], v[2:17]
	v_fma_f32 v138, v84, s6, -v131
	v_fma_f32 v139, v85, s6, -v131
	ds_read_b128 v[82:85], v183
	v_fma_f32 v144, v92, s6, -v131
	v_fma_f32 v145, v94, s6, -v131
	v_fma_f32 v146, v95, s6, -v131
	v_fma_f32 v147, v96, s6, -v131
	s_waitcnt lgkmcnt(1)
	...
	v_fma_f32 v86, v86, s6, -v131
	v_fma_f32 v87, v87, s6, -v131
	v_fma_f32 v88, v88, s6, -v131
	...
	ds_read_b128 v[160:163], v187
	ds_read_b128 v[86:89], v188
	v_fma_f32 v90, v90, s6, -v131
	v_exp_f32_e32 v127, v139
	v_sub_f32_e32 v82, v171, v131
	...
	s_waitcnt vmcnt(0)
	ds_write_b128 v177, v[134:137] offset:8192
	buffer_load_dwordx4 v[82:85], v185, s[0:3], 0 offen
	s_waitcnt lgkmcnt(0)
	s_barrier
	v_cvt_f16_f32_e32 v118, v128
	v_cvt_f16_f32_e32 v119, v130
	...
	v_cvt_f16_f32_e32 v135, v92
	v_cvt_f16_f32_e32 v136, v94
	v_cvt_f16_f32_e32 v116, v95
	v_cvt_f16_f32_e32 v117, v96
	v_cvt_f16_f32_e32 v137, v97
	...
	ds_read_u16 v183, v154 offset:13184
	ds_read_u16 v184, v154 offset:13248
	ds_read_u16 v185, v154 offset:13056
	ds_read_u16 v186, v154 offset:12992
	...
	v_pack_b32_f16 v101, v136, v116
	v_pack_b32_f16 v100, v134, v135
	v_perm_b32 v104, v158, v111, s5
	v_mfma_f32_32x32x8_f16 v[50:65], v[88:89], v[98:99], v[50:65]
	s_waitcnt lgkmcnt(8)
	v_perm_b32 v89, v185, v106, s5
	...
	ds_read_u16 v131, v154 offset:12416
	ds_read_u16 v133, v154 offset:12800
	ds_read_u16 v134, v154 offset:12864
	ds_read_u16 v135, v154 offset:12928
	ds_read_u16 v136, v154 offset:14336
	...
	ds_read_u16 v133, v154 offset:15168
	ds_read_u16 v146, v154 offset:15104
	...
	v_perm_b32 v74, v113, v136, s5
	v_pack_b32_f16 v76, v82, v83
	s_waitcnt lgkmcnt(0)
	v_add_f32_e32 v82, v89, v78
	v_add_f32_e32 v78, v128, v130
	...
	v_perm_b32 v75, v169, v135, s5
	v_perm_b32 v74, v164, v131, s5
