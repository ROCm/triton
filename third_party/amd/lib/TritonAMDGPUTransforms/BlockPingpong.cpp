...
/*
  for (int j=0; j<4; j++){
    appendOp(subViewOps[1][j]);
    appendOp(subViewOps[3][j]);
    appendOp(loadSliceOps[1][j]);
    appendOp(loadSliceOps[3][j]);
  }

  for (int j=0; j<4; j++){
    appendOp(subViewOps[0][j]);
    appendOp(subViewOps[2][j]);
    appendOp(loadSliceOps[0][j]);
    appendOp(loadSliceOps[2][j]);
